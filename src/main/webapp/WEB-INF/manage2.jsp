...
<jsp:useBean id="notices" scope="request" type="java.util.List<com.example.entity.Notice>"/>
    ...
    <div class="main-content w-95">
        <div class="d-flex justify-content-between mb-4">
            <div class="input-group search-box">
                <form action="searchnotice" method="get">
                    <div style="display: flex">
                        <input type="text" class="form-control" name="id" placeholder="请输入公告Id">
            ...
            <form action="addnotice" method="post">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" ><i class="bi bi-plus-circle me-1"></i>添加公告</button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form>
                                    <div class="mb-3">
                                        <label for="notice-name" class="col-form-label">公告标题</label>
                                        <input type="text" class="form-control" id="notice-name" name="name">
                                    </div>
                                    <div class="mb-3">
                                        <label for="message-text" class="col-form-label">公告内容</label>
                    ...
                    <form action="updatenotice" method="post" >
                        <div class="modal fade" id="editModal_${n.id}" tabindex="-1" aria-labelledby="editModalLabel_${n.id}" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="editModalLabel_${n.id}">编辑公告</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <!-- 隐藏字段用于传递新闻ID -->
                                        ...
                                        <div class="mb-3">
                                            <label for="edit-notice-name_${n.id}" class="col-form-label">公告标题</label>
                                            <input type="text" class="form-control" id="edit-notice-name_${n.id}" name="name" value="${n.name}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="edit-message-text_${n.id}" class="col-form-label">公告内容</label>
...
<script>
    function deleteNotice(id) {
        if (confirm('确定要删除这条公告吗？')) {
            ...
            form.method = 'POST';
            form.action = 'deletenotice?id=' + id;
